	...
	<div class="outer">
		...
		<div style="width: 800px; margin: auto; text-align: left;">
			<p>
				...
				1. 안전한 결제 시스템:<br> 구매자가 물품을 받은 후, 판매자에게 카카오 화폐가 전달됩니다. 이를 통해 물품을 미리 보내고 돈을 받지 않는 위험을 방지할 수 있습니다.<br><br>
				2. 신속한 거래:<br> 카카오 화폐는 즉시 사용 가능하며, 실시간으로 거래가 진행되어 빠르고 간편하게 결제가 이루어집니다.<br><br>
				3. 보안성 강화:<br> 카카오 화폐는 플랫폼 내에서만 사용 가능하며, 외부의 위험으로부터 보호됩니다.<br><br><br>
				<b style='font-size: 25px;'>카카오 화폐 구매 방법</b><br><br>
				1) 로그인 후 [KH 중고 마켓 > 상단메뉴(KAKAO구매)]에 접속합니다.<br><br>
				2) 카카오 화폐 구매 페이지로 이동합니다.<br><br>
				3) 원하시는 금액을 선택하고 결제 방법을 선택하여 구매합니다.<br><br>
				4) 구매한 카카오 화폐는 즉시 계정에 적립되어 안전결제에 사용할 수 있습니다.<br><br>
				5) 카카오 화폐로 안전하게 거래하기<br><br>
				6) 거래 전에 판매자에게 카카오 화폐를 통해 결제를 진행하여 물품이 안전하게 배송될 때까지 금액을 보관합니다.<br><br>
