...
<body>
	...
	<div class="outer">
		...
		<button class="btn-kakao" style="float: right; margin-right: 20px;" onclick="writeNoticeBtn();">작성완료</button>
		<br><br><br>
	    <div class="inner">
	    	<!-- 공지사항 제목 -->
		    ...
		    <div id="notice-content">
		        ...
		        <p><textarea id="noticeContent" name="noticeContent" style="resize: none;"></textarea></p>
		    </div>
		    <!-- 공지사항 작성 날짜 -->
		    <div id="notice-date">
	...
	<script>
		...
		function writeNoticeBtn(){
			...
			$.ajax({
				url : "${contextPath}/board/insertNotice",
				data : {
					noticeTitle : noticeTitle,
					noticeContent : noticeContent,
					noticeWriter : "${loginUser.userId}"
				},
