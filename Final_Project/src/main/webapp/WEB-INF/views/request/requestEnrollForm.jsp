...
<body>
	...
	<div class="outer">
		...
		<button class="btn-kakao" style="float: right; margin-right: 20px;" onclick="writeRequestBtn();">작성완료</button>
		<br><br><br>
	    <div class="inner">
	    	<!-- 문의글 제목 -->
		    <div id="notice-header">
	        	<label for="sceretCheck" class="kakao-checkbox">
				    <input type="checkbox" id="sceretCheck" class="kakao-checkbox-input">
		    ...
		    <div id="notice-content">
		        ...
		        <p><textarea id="requestContent" name="requestContent" style="resize: none;"></textarea></p>
		    </div>
		    <!-- 문의글 작성 날짜 -->
		    <div id="notice-date">
	...
	<script>
		...
		// 게시물 작성하기 버튼
		function writeRequestBtn(){
			var requestTitle = $("input[name=requestTitle]").val();
			var requestContent = $("textarea[name=requestContent]").val();
			var requestWriter = $("#notice-date-text").text();
			var lockStatus = $("#sceretCheck").prop("checked");
			...
			$.ajax({
				url : "${contextPath}/board/insertRequest",
				data : {
