...
<body>
	...
	<div class="outer">
		...
		<button class="btn-kakao" style="float: right; margin-right: 20px;" onclick="updateRequestBtn();">수정완료</button>
		<br><br><br>
	    <div class="inner">
	    	<!-- 공지사항 제목 -->
		    <div id="notice-header">
		        <h1 id="notice-title">
		        	<input type="text" name="requestTitle" value="${r.requestTitle}">
		        </h1>
		    </div>
		    <!-- 공지사항 내용 -->
		    <div id="notice-content">
		        ...
		        <p><textarea id="noticeContent" name="requestContent" style="resize: none;">${r.requestContent}</textarea></p>
		    </div>
		    <!-- 공지사항 작성 날짜 -->
		    <div id="notice-date">
	...
	<script>
		...
		function updateRequestBtn(){
			...
			$.ajax({
				url : "${contextPath}/board/updateRequest",
				data : {
